...
(function () {
  ...
  /* Target the glass header that contains the timer */
  const header = document.querySelector('.glass.exam-header-sticky') ||
                 Array.from(document.querySelectorAll('.glass')).find(el =>
